    ...
    "design": {
      "pages": {
        _page: (page: string | number) => ({
          $url: (url?: { hash?: string }) => ({ pathname: '/articles/design/pages/[page]' as const, query: { page }, hash: url?.hash })
        })
      }
    },
    "society": {
      "pages": {
        _page: (page: string | number) => ({
          $url: (url?: { hash?: string }) => ({ pathname: '/articles/society/pages/[page]' as const, query: { page }, hash: url?.hash })
        })
      }
    },
    "technology": {
      "pages": {
        _page: (page: string | number) => ({
          $url: (url?: { hash?: string }) => ({ pathname: '/articles/technology/pages/[page]' as const, query: { page }, hash: url?.hash })
        })
      }
    },
